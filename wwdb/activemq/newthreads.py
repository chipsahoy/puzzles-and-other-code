...
conn.send(message="read lobby!", destination=readlobby, 
	headers={'expires': milliseconds, 'BaseURL':'http://forumserver.twoplustwo.com/59/puzzles-other-games/',
	'startPage':pageNumber,'endPage':endPage, 'recentFirst':'True', 'CurrentUTC':timerow['curtime'] + " GMT"}, ack='auto')
