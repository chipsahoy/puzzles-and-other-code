...
<?php
	...
	echo "Games Played: ".$games['n']."<br/>
		...
		<div style='margin-left:25px;'> Village Win %: ".number_format(round($stats['wins']/$stats['games'], 3), 3)."</div>
		<div style='margin-left:25px;'> Slow Games: ".$games['slow'].
		"<div style='margin-left:25px;'> Village Win %: ".number_format(round($stats2['wins']/$stats2['games'], 3), 3)."</div>
		</div>";
	...
	echo "Vanilla+'s Played: ".$games['vplus']."<br/>
		<div style='margin-left:25px;'> Players per game: ".number_format(round($stats2['p']/$stats2['n'], 1), 1)."</div>
		<div style='margin-left:25px;'> Village Win %: ".number_format(round($stats['vwin']/$stats['games'], 3), 3)."</div>
		<div style='margin-left:25px;'> Wolf Win %: ".number_format(round($stats['wwin']/$stats['games'], 3), 3)."</div>
		<div style='margin-left:25px;'> Neutral Win %: ".number_format(round($stats['nwin']/$stats['ngames'], 3), 3)."</div>";
